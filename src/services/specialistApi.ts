...
import { Specialty, PaginatedSpecialists, SpecialistFilter } from '../types/specialist';
import { BulkAction } from '../types/admin';

export const specialistApi = {
  async getSpecialists(filter: SpecialistFilter & { page?: number; limit?: number }): Promise<PaginatedSpecialists> {
